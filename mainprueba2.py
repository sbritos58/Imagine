...
<IniciarSesion>:
    ...
    FloatLayout:
        ...
        Label:
            ...
            size:root.size
            text:"[i][b][color=4286f4][u]USUARIO[/color][/b][/u][/i]"
            markup:True
...
#**********************************************write_tab false permite tabular de un input a otro***************************************
        ...
        Label:
            ...
            size:root.size
            text:"[i][b][color=4286f4][u]¿HAS OLVIDADO TU CONTRASEÑA?[/color][/b][/u][/i]"
            markup:True
...
#**********************************************write_tab false permite tabular de un input a otro***************************************
        ...
        Button:
            ...
            on_press:
                ...
                root.agregar(nombre_organizacion.text,usuario_organizacion.text,email_organizacion.text,telefono_organizacion.text,contrasena_organizacion.text)
                root.manager.transition.direction = "left"
                root.manager.transition.duration = .3
                root.manager.current = "RegistroExitoso"
...
#**********************************************write_tab false permite tabular de un input a otro***************************************
        ...
        Button:
            ...
            on_press:
                ...
                root.agregar(nombre_usuario.text,apellido_usuario.text,email_usuario.text,contrasena_usuario.text)
...
#**********************************************write_tab false permite tabular de un input a otro***************************************
        ...
        Button:
            ...
            on_press:
                ...
                root.guardarDonacion(producto_productos.text,cantidad_productos.text,ciudad_productos.text,barrio_productos.text,destino_productos.text)
                root.manager.transition.direction = "left"
                root.manager.transition.duration = .3
                root.manager.current = "DonacionExitosa"
...
class IniciarSesion(Screen):
    ...
    def validacionregistro(self):
        ...
        con = sqlite3.connect("base.db")
        cur = con.cursor()
        cur.execute("select * from organizacion where nombre = ? and contrasena = ?",(usuario,contrasena))
        hola = cur.fetchall()
        cur.execute("select * from particular where nombre = ? and contrasena = ?",(usuario,contrasena))
        chau = cur.fetchall()
        if hola or chau:
...
class Personal(Screen):
    ...
    def agregar(self,nombre_usuario,apellido_usuario,email_usuario,contrasena_usuario):
...
class Organizaciones(Screen):
    ...
    def agregar(self,nombre_organizacion,usuario_organizacion,email_organizacion,telefono_organizacion,contrasena_organizacion):
...
class Donador(Screen):
    ...
    def guardarDonacion(self,producto_productos,cantidad_productos,ciudad_productos,barrio_productos,destino_productos):
        global productos
